...
namespace RealEstate.Web.Migrations
{
    ...
    [Migration("20190407014633_UpdateContactDetails")]
    partial class UpdateContactDetails
    {
            ...
            modelBuilder.Entity("RealEstate.Domain.Tables.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "f145a138-2d54-4583-83f8-4480de3bf8bb",
                            Address = "باهنر",
                            DateTime = new DateTime(2019, 4, 7, 6, 16, 32, 706, DateTimeKind.Local).AddTicks(8836),
                            FirstName = "هانی",
                            LastName = "موسی زاده",
                            Mobile = "09166000341",
